...
export function buildProd(env) {
  ...
  process.exit(shell.exec(`./node_modules/.bin/webpack --config webpack/prodConfig.js --progress --profile --colors --env.networkName=${argv.env}`).code);
}

export function buildDev(env) {
